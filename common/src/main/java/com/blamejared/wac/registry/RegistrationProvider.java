package com.blamejared.wac.registry;
...
public interface RegistrationProvider<T> {
    ...
    default <I extends T> RegistryObject<I> blockItem(String name, RegistryObject<? extends Block> block, UnaryOperator<Item.Properties> supplier) {
    ...
    default <I extends T> RegistryObject<I> blockItem(String name, RegistryObject<? extends Block> block, UnaryOperator<Item.Properties> supplier, Item.Properties defaultProperties) {
